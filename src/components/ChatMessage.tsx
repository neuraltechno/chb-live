  ...
  return (
    <div
      className={cn(
        ...
        isMatchBot && "justify-center w-full my-2"
      )}
    >
      {/* Avatar */}
      {!isMatchBot && (
      ...
      <div
        className={cn(
          isMatchBot ? "max-w-[90%]" : "max-w-[75%]",
          isOwnMessage ? "items-end" : "items-start",
          isMatchBot && "items-center text-center"
        )}
      >
        {/* Username */}
        {!isOwnMessage && !isMatchBot && (
          <button
            onClick={handleAvatarClick}
          ...
          <div
            className={cn(
              ...
              isOwnMessage
                ...
                : isMatchBot
                ? "bg-accent-blue/10 border border-accent-blue/30 text-accent-blue-light italic"
