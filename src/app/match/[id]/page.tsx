  ...
  useEffect(() => {
    ...
    const updateTitle = () => {
      ...
      if (game.status === "live" || game.status === "halftime" || game.status === "finished") {
        ...
        console.log(`[MatchPage Title Update] Visibility: ${document.visibilityState}, Status: ${game.status}, Score: ${homeScore}-${awayScore}, Title: ${newTitle}`);
    ...
    // Ensure the title stays updated even in background
    ...
    <div className="h-[calc(100vh-80px)] flex flex-col lg:flex-row bg-dark-950 overflow-hidden">
      ...
      <div className="lg:w-[15%] flex-shrink-0 bg-dark-900 border-r border-dark-700/50 flex flex-col overflow-hidden">
        <div className="px-3 py-2 border-b border-dark-700/50">
          <button
            onClick={() => router.push("/")}
            className="flex items-center gap-2 text-dark-400 hover:text-white transition-colors text-[12px]"
          >
      ...
      <div className="lg:w-[70%] flex-1 bg-dark-950 flex flex-col overflow-hidden">
        <div className="px-4 py-2.5 border-b border-dark-700/50 bg-dark-900/50 backdrop-blur-sm z-10 flex items-center justify-between">
          <div className="flex items-center gap-4">
            <h2 className="text-base font-bold text-white flex items-center gap-2">
              <span className="w-1 h-5 bg-primary-500 rounded-full"></span>
              {game.homeTeam.shortName} vs {game.awayTeam.shortName}
            </h2>
            <div className="flex items-center gap-3 text-[10px] text-dark-400 border-l border-dark-700/50 pl-4">
              {game.venue && (
              ...
              <div className="flex items-center gap-1">
                <Calendar className="w-3 h-3 text-primary-500/70" />
              ...
              {statusText && (
                <div className="flex items-center gap-1 border-l border-dark-700/50 pl-4">
